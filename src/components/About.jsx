  ...
  return (
    <div className="details" id="details">
      ...
      <p className="additional-text fs-6">
        ...
        <br></br>
        I am a <span className="fw-bold" style={{color: "#128C7E"}}>Full-stack</span> & <span className="fw-bold" style={{color: "#7B61FF"}}> LLM Applications </span> developer specializing in <span className="fw-bold" style={{color:"#61DBFB"}}> React </span> frontend, <span className="fw-bold" style={{color:"#3776ab"}}> Pyt</span><span className="fw-bold" style={{color: "#ffd343"}}>hon </span> backend development 
        <br></br>

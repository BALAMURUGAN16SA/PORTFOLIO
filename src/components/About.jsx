  ...
  return (
    <div className="details" id="details">
      ...
      <p className="additional-text fs-6">
        ...
        <br></br>
        I am a <span className="fw-bold" style={{color: "#128C7E"}}>Full-stack developer </span> specializing in <span className="fw-bold" style={{color:"#61DBFB"}}> React </span> frontend and <span className="fw-bold" style={{color:"#ffd343"}}> Python </span> backend development.
        <br></br>
        <br></br>
